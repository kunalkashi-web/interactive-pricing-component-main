...
const updatePageViews = () => {
    ...
    viewsContainer.innerHTML = `${pageViews} pageviews`
};
...
if (isAnnual) {priceFreqContainer.innerHTML = '/ year'}
else{priceFreqContainer.innerHTML = '/ month'}
...
const updateCost = () =>{
    ...
    costContainer.innerHTML = `$${price.toFixed(2)}`
